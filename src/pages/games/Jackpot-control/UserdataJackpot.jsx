...
const UserdataJackpot= () => {
  ...
  return (
    <div className="p-4 bg-gray-50 min-h-screen">
      ...
      {/* Main Table */}
      <div className="bg-white rounded-xl shadow-lg overflow-x-auto border border-gray-200 max-w-[155vh] overflow-w-auto">
...
export default UserdataJackpot;
